...
import 'package:flamingo/shared/util/response.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/foundation.dart';

class BrandScreenModel extends ChangeNotifier {
  ...
  Response<List<Profile>> _listofprofile = Response<List<Profile>>();
  Response<List<Profile>> get listofprofile => _listofprofile;
  ...
  void setlistofprofile(Response<List<Profile>> response) {
    _listofprofile = response;
    notifyListeners();
  }
  ...
  Future<void> getbranddata() async {
    setlistofprofile(Response.loading());
    final profilelist = await _profileRepository.getbrandProfile();
    userlist = profilelist;

    setlistofprofile(Response.complete(profilelist));
  }
}
